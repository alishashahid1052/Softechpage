const Team = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Machine learning expert with focus on AI solutions and data analytics.",
    ...
    },
    {
      ...
      bio: "Infrastructure specialist with expertise in cloud deployment and automation.",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Our talented team of experts is dedicated to delivering innovative solutions and exceptional results.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {teamMembers.map((member, index) => (
            <div
              key={index}
              className="bg-dark-800 rounded-xl p-6 border border-dark-700 hover:border-primary-500/50 transition-all duration-300 hover:transform hover:scale-105"
            >
              <div className="text-center">
                <div className="relative w-32 h-32 mx-auto mb-6">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-full h-full object-cover rounded-full border-4 border-primary-500/20"
                  />
                </div>
