const Services = () => {
  const services = [
    ...
    },
    {
      ...
      features: ["Custom AI Models", "Data Analytics", "Chatbots", "Predictive Analytics"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      features: ["AWS/Azure/GCP", "DevOps", "CI/CD", "Serverless Architecture"]
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-dark-800 p-8 rounded-xl border border-dark-700 hover:border-primary-500/50 transition-all duration-300 hover:transform hover:scale-105"
            >
